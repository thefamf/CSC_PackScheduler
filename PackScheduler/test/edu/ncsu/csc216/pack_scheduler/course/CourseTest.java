...
public class CourseTest {
	...
	private static final int ENROLLMENTCAP = 50;
	/** Course meeting days */
	 ...
	 */
	@Test
	public void testCourseStringStringStringIntStringIntStringIntInt() {
		//Setting name can only be tested through the constructor
		
		//Testing for null name
		Course c = null;
		try {
			c = new Course(null, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		...
		c = null;
		try {
			c = new Course("", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("E11", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("CSC2167", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		
		//Test for invalid enrollment cap
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 0, MEETING_DAYS, START_TIME, END_TIME);
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
	 ...
	 */
	@Test
	public void testCourseStringStringStringIntStringIntString() {
		//Test a valid construction and make sure values are correct
		Course c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, "A");
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
			assertEquals(SECTION, c.getSection());
			assertEquals(CREDITS, c.getCredits());
	...
	public void testGetMeetingString() {
		...
		Activity c5 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, 30, 125);
		assertEquals("MW 12:30AM-1:25AM", c5.getMeetingString());
	...
	public void testGetShortDisplayArray() {
		...
		//Get the Course and make sure contents are correct
		//Name, section, title, meetingString
		String [] course = c.getShortDisplayArray();
		//Row 0
		assertEquals("CSC216", course[0]);
		assertEquals("001", course[1]);
		assertEquals("Programming Concepts - Java", course[2]);
		assertEquals("MW 1:30PM-2:45PM", course[3]);
		assertEquals("50", course[4]);
	...
	public void testGetLongDisplayArray() {
		...
		//Get the Course and make sure contents are correct
		//Name, section, title, meetingString
		String [] course = c.getLongDisplayArray();
		//Row 0
		assertEquals("CSC216", course[0]);
		assertEquals("001", course[1]);
		assertEquals("Programming Concepts - Java", course[2]);
		assertEquals("4", course[3]);
		assertEquals("sesmith5", course[4]);
		assertEquals("MW 1:30PM-2:45PM", course[5]);
	...
	public void testisDuplicate() {
		...
		Course c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);

		//Check if c2 is a duplicate of c1, both ways
	...
	/**
	 * Test method for compareTo() by creating two Courses that are equal and one Course that is greater than the first two.
	 * Tests will check that the first two Courses are equal and that the first and second Courses are less than the third Course and vice versa.
	 * Tests will compare Courses based on course name, then section.
	 */
	@Test
	public void testCompareTo() {
		Course c1 = new Course("CSC216", "Programming Concepts - Java", "001", 4, "sesmith5", 50, "MW", 1330, 1445);
		Course c2 = new Course("CSC216", "Programming Concepts - Java", "001", 4, "sesmith5", 50, "MW", 1330, 1445);
		Course c3 = new Course("CSC226", "Discrete Mathematics for Computer Scientists", "001", 3, "tmbarnes", 50, "MWF", 935, 1025);
				
		// test c1 is less than c3 and that c1 is equal to c2 for course name, in both directions
		assertTrue(c1.compareTo(c3) < 0);
		assertTrue(c3.compareTo(c1) > 0);
		assertTrue(c1.compareTo(c2) == 0);
		assertTrue(c2.compareTo(c1) == 0);

		// construct new Courses with same names, with third Course with a different section, and then compare based on section
		// need new Courses because setCourse() is private in Course()
		Course c4 = new Course("CSC216", "Programming Concepts - Java", "001", 4, "sesmith5", 50, "MW", 1330, 1445);
		Course c5 = new Course("CSC216", "Programming Concepts - Java", "001", 4, "sesmith5", 50, "MW", 1330, 1445);
		Course c6 = new Course("CSC216", "Programming Concepts - Java", "002", 3, "tmbarnes", 50, "MWF", 935, 1025);
		assertTrue(c4.compareTo(c6) < 0);
		assertTrue(c6.compareTo(c4) > 0);
	...
	public void testEqualsObject() {
		...
		Activity c3 = new Course("CSC000", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c4 = new Course(NAME, "Different", SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c5 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c6 = new Course(NAME, TITLE, SECTION, 5, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c7 = new Course(NAME, TITLE, SECTION, CREDITS, "Different", ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c8 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, "TH", START_TIME, END_TIME);
		Activity c9 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, 830, END_TIME);
		Activity c10 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, 1400);
	...
	public void testHashCode() {
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
		Activity c3 = new Course(NAME, "Different", SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENTCAP, MEETING_DAYS, START_TIME, END_TIME);
